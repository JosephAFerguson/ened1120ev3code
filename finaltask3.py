#!/usr/bin/env python3
"""
    From beginning of an aisle, travel to box location 9, then scan the barcode.
"""
...
from final import MoveForward, ScanBarcode, TurnClockwise, MovementToBox, MoveToFulfill
